...
def Shortest_distance(problem, fringe):
    Lista_Cerrada = {}
...
def ramificacion_acotacion(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return graph_search(problem, Ordena_sin_heuristica())

def ramificacion_acotacion_subestimacion(problem):
    """Search the shallowest nodes in the search tree first. [p 74]"""
    return graph_search(problem, Ordena_con_heuristica(problem))
    pass
